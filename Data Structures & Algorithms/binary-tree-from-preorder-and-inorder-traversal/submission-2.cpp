...
public:
    ...
    {   
        ...
        root->left =  buildRecu(preorder,inorder,inorder_pos,in_start,root_LDRpos,cur_root);
        root->right = buildRecu(preorder,inorder,inorder_pos,root_LDRpos + 1,in_end,cur_root);
        return root;
    }
};
